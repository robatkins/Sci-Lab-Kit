...
def generate_cosine_wave(t, frequency, amplitude):
...
ax.set_title('Cosine Wave Animation')  # Update the title
...
# Animation function
def update(frame):
    y = generate_cosine_wave(t[:frame + 1], frequency, amplitude)
...
plt.figure(1).canvas.setWindowTitle('Cosine Wave Animation')
